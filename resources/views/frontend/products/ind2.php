                    ...
                    <div class="shop-sidebar mr-50">
                        <form method="GET" action="{{ url('products')}}">
                            <div class="sidebar-widget mb-40">
                                <h3 class="sidebar-title">Filter Berdasar Harga</h3>
							...
							<div class="shop-bar pb-60">
								<div class="shop-found-selector">
									<div class="shop-found">
										<p><span>{{ count($products) }}</span> Produk yang ditemukan <span>{{ $products->total() }}</span></p>
									</div>
                                                ...
                                                <div class="product-wrapper mb-30">
                                                    <div class="product-img">
                                                        ...
                                                        <div class="product-action">
                                                            ...
                                                            <a class="animate-top add-to-card" title="Tambahkan Keranjag" href="" product-id="{{ $product->id }}" product-type="{{ $product->type }}" product-slug="{{ $product->slug }}">
                                            ...
                                            <div class="product-wrapper mb-30 single-product-list product-list-right-pr mb-60">
                                                <div class="product-img list-img-width">
                                                    ...
                                                    <div class="product-action-list-style">
                                                        <a class="animate-right" title="Lihat" data-toggle="modal" data-target="#exampleModal" href="#">
                                                            <i class="pe-7s-look"></i>
                                                        </a>
                                                    </div>
                                                </div>
